# OPA Version Management with opavm
...
```json
{
  ...
  "available": true,
  "version": "1.2.3",
  "path": "/home/user/.opavm/versions/1.2.3/opa",
...
```json
{
  ...
  "opavm": {
    "available": true,
    "which": "/home/user/.opavm/versions/1.2.3/opa",
    "current": "OPA 1.2.3 (global default)"
  }
}
```
...
```json
{
  ...
  "available": true,
  "version": "0.38.1",
  "path": "/home/user/.opavm/tools/regal/versions/0.38.1/regal",
...
```json
{
  ...
  "opavm": {
    "available": true,
    "which": "/home/user/.opavm/tools/regal/versions/0.38.1/regal",
    "current": "Regal 0.38.1 (global default)"
  }
}
```
